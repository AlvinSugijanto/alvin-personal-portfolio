export const projectsData = [
  {
    title: "Job Scraper",
    description:
      "A full-stack application to scrape and manage job listings from multiple web portal (LinkedIn, JobStreet, Kalibrr).",
    longDescription:
      "JobScraper is a robust, full-stack web application designed to streamline the job search process. It aggregates job listings from various online platforms, including LinkedIn, JobStreet, and Kalibrr, providing users with a centralized dashboard to discover and manage career opportunities.",
    thumbnail:
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/1_amgn89.png",
    images: [
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/1_amgn89.png",
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264032/2_g6vlxu.png",
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/3_ujgszy.png",
    ],
    technologies: ["Next.js", "Python", "BeautifulSoup", "FastAPI"],
    demoLink: "https://github.com/AlvinSugijanto/job_scraper",
    githubLink: "https://github.com/AlvinSugijanto/job_scraper",
  },
  {
    title: "Sugijanto AI",
  ...
  },
  {
    title: "Font Controls",
    description:
      "A lightweight font controls library for React. Provides an intuitive GUI panel for adjusting typography settings in real-time.",
    longDescription:
      "FontControls is a React library that simplifies the process of implementing dynamic font styling. It offers a user-friendly interface for adjusting font size, weight, line height, and letter spacing, making it an invaluable tool for developers looking to enhance their application's typography.",
    thumbnail:
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/1_tf2iom.png",
    images: [
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/1_tf2iom.png",
    ],
    technologies: ["React", "NPM"],
    demoLink: "https://www.npmjs.com/package/font-controls",
  ...
  },
  {
    ...
    images: [
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264031/1_cxeklg.png",
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264030/2_srwvc1.png",
...

  {
    ...
    images: [
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264034/2_unouxs.png",
      "https://res.cloudinary.com/dqax2zl31/image/upload/v1774264034/1_jngxxr.png",
